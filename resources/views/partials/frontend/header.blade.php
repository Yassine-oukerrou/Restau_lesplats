<header class="header clearfix element_to_stick">
    ...
    <div class="container-fluid">
        <div id="logo">
            <a href="{{ route('home') }}">
                <img src="{{ asset($general ? $general->logo:'uploads/logo/20221211174521.png') }}" width="140" height="35" alt="" class="logo_normal">
            ...
            @guest
                ...
                <li>
                    <div class="dropdown dropdown-cart">
                        <a href="" class="cart_bt"><i class="fas fa-cart-plus"></i> <strong>1</strong></a>
                    </div>
                </li>
            @endguest
        </ul>
