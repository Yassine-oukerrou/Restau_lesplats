                    ...
                    <div class="box_booking">
                        ...
                        <div class="main">
                            <ul class="clearfix">
                                ...
                                <li>20 x 10<span>$ 20</span></li>
                              
                            </ul>

                            <ul class="clearfix">
                                <li>Subtotal<span>$ 20</span></li>
                                <li>Delivery fee<span>$ 10</span></li>
                                <li class="total">Total<span>$15</span></li>
                                <input type="hidden" name="total" value="15">
                            </ul>
                            <button type="submit" class="btn_1 full-width mb_5">Order Now</button>
                            <div class="text-center"><small>Or Call Us at <strong>0000000</strong></small>
                            </div>
                        </div>
                    </div>
                </div>
